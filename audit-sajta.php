    ...
    <div class="container ">
        <div class="header__title header__title_subservice">
            <div class="header_link_str">
                ...
                <p class="header_link_str_twxt">Аудит сайта
                </p>
            </div>
            <h1 class="header__title_text header__title_text_subservice h1">Аудит сайта
            </h1>
            <p class="header_text p3_black header_text_subservice">Аудит сайта – прекрасная возможность узнать, на сколько Вы используете потенциал рекламного контента. Специалисты компании «Веб Фокус» проверят Ваш сайт с каждой стороны и на всех этапах. После комплексного аудита сайта, Вы узнаете, используете ли все возможности для развития бизнеса, почему сайт теряет позиции или плохо индексируется, как улучшить техническую или дизайнерскую сторону для эффективного продвижения. Эти актуальные проблемы при проверке выявят специалисты, но это еще не все, они разработают четкую схему того, как их устранить и позволить Вашему бизнесу продолжать стабильное развитие.
            </p>
        </div>
...
<section class="preview padding_bottom_150 padding_top_130 padding_top_114_1440">
    <div class="container container_one_500">
        <p class="preview__subtitle padding_bottom_10 p2_white">глубокая проверка Вашего сайта
        </p>
        <h2 class="preview__title padding_title_60 h2_grad preview__title_subservice">Цели и их выполнение
        </h2>
        <div class="preview__block padding_title_60 padding_52_1440">
            <div class="text__wrapper">
                <div class="preview__block_text preview__block_text-1">
                    ...
                    <div class="preview_display_block">
                        <p class="col-text-2--p p3_white margin_30_768">Работа нашей компании заключается не только в оценке бизнеса, но и в разработке стратегий для совершенствования. При работе с клиентами, мы стремимся охватить все сферы рекламного продвижения: разработка и проектирование, продвижение и оптимизация, дизайн и графика. Такой комплексный подход позволяет привести новых клиентов из поиска прямиком к Вашему товару. <br><br>
                            Благодаря тому, что мы работали с компаниями из разных областей, опыт огромен. Специалисты студии знают, как прорекламировать все, начиная от салона красоты, заканчивая автомобильными компаниями.<br><br>
                            Главная задача digital-агентства – направление потока клиентов на Ваш сайт и социальные сети. Работая в интернете, Вы заявляете себя на миллиардную аудиторию, но, где потребители, там и конкуренты. Задачей компании является усовершенствование рекламы и грамотное ее использование для увеличения конкурентоспособности.
            ...
            <div class="text__wrapper">
                <div class="preview__block_text preview__block_text-1">
                    <div class="grad-line"></div>
                    <div class="preview_display_block">
                        <p class="col-text-2--p p3_white margin_30_768">Сейчас конкуренция в интернете огромна. Нельзя допускать ослабления позиций сайта. Даже если Вы располагаете хорошей оптимизацией сайта, нужно регулярно работать над укреплением позиций в ТОПе. Нельзя добиться совершенства проекта без доработок или внедрений новых элементов. В рамках комплексного SEO-аудита мы выясним факторы, которые препятствуют развитию ресурса.<br><br>
                            Комплексный аудит сайта состоит из технического и юзабилити аудитов. Заказать аудита сайта, как технический, так и юзабилити Вы можете по отдельности.
                        </p>
                    </div>
                </div>
            </div>
